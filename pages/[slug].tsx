...
export default function WeddingPage({ wedding }: WeddingPageProps) {
  ...
  return (
    <>
      <Head>
        <title>{content.groom_name} & {content.bride_name} - Wedding Invitation</title>
        <meta name="description" content={`Join us for the wedding of ${content.groom_name} and ${content.bride_name}`} />
      </Head>
      ...
      <div className="min-h-screen font-sans text-gray-800 bg-[#FDFBF7]">
        ...
        <div className="bg-white py-20 px-6">
            <div className="max-w-4xl mx-auto text-center space-y-12">
                <h2 className="text-4xl font-serif font-bold text-gray-900 icon-heading">
                    Event Details
                </h2>
                ...
                <div className="grid md:grid-cols-3 gap-8">
                    ...
                    <div className="p-8 rounded-2xl bg-pink-50 hover:shadow-lg transition">
                        ...
                        <h3 className="text-xl font-bold mb-2">Where</h3>
                         <p className="text-gray-600">
                            {content.address || 'Address TBD'}
                        </p>
                        {content.map_url && (
                            <a href={content.map_url} target="_blank" rel="noreferrer" className="text-pink-600 text-sm font-bold underline mt-2 block">
                                View Map
                            </a>
                        )}
                    </div>
