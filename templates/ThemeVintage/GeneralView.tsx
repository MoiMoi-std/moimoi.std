...
export default function VintageGeneralView({
  wedding,
  disableSplash,
  musicUrl,
  guestName = '',
        ...
        <style>{`
          *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
          ...
          @container (max-width: 896px) {
            ...
            .vintage-splash-hy-ornament-left { transform: translate(-132px, -50%); }
            .vintage-splash-hy-ornament-right { transform: translate(64px, -50%) scaleX(-1); }
            .vintage-rsvp-grid { grid-template-columns: 1fr !important; }
          }
          ...
          <div style={{ padding: '24px 20px 10px' }}>
            ...
            >
              ...
              <div style={{ display: 'grid', gap: 10 }}>
                ...
                <div className='vintage-rsvp-grid' style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 10 }}>
                  <select
                    className='vintage-rsvp-control'
                    value={demoAttend}
