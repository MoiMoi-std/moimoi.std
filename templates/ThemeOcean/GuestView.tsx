...
export default function OceanGuestView({ wedding, guestName, rsvpId }: TemplateProps) {
  ...
  return (
    <>
      <Head>
        <link
          href='https://fonts.googleapis.com/css2?family=Playfair+Display:ital,wght@0,400;1,400&family=Nunito:wght@300;400&display=swap'
          rel='stylesheet'
        />
      ...
      <div style={{ background: seafoam, fontFamily: "'Nunito', sans-serif", color: textDark, overflowX: 'hidden' }}>
          ...
          {mergedContent.cover_image && (
            <div
              style={{
                ...
                filter: 'brightness(0.38) saturate(0.7) hue-rotate(10deg)'
              }}
            />
          )}
          <div
            style={{
              position: 'absolute',
              inset: 0,
              background: 'linear-gradient(to bottom, rgba(10,36,53,0.4) 0%, rgba(10,36,53,0.82) 100%)'
            }}
          />
            ...
            {guestName && (
              <div
                style={{
                  marginTop: 22,
                  padding: '12px 22px',
                  border: `1px solid rgba(78,198,216,0.3)`,
                  borderRadius: 24
                }}
              >
                <p
        ...
        <section style={{ background: tealDark, padding: '36px 24px', textAlign: 'center' }}>
          ...
          <p style={{ fontSize: 8, letterSpacing: '0.3em', color: `rgba(78,198,216,0.3)`, textTransform: 'uppercase' }}>
            MoiMoi Studio
          </p>
        </section>
      </div>
