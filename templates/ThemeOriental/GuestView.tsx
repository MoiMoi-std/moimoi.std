          ...
          {mergedContent.cover_image && (
            <div
              style={{
                ...
                filter: 'brightness(0.3) saturate(0.7) sepia(0.3)'
              }}
            />
          )}
          {!mergedContent.cover_image && (
            <div
              style={{ position: 'absolute', inset: 0, background: `linear-gradient(160deg, ${darkRed}, ${red})` }}
            />
          )}
          <div
            style={{
              ...
              inset: 0,
              background:
                'linear-gradient(to bottom, rgba(92,10,10,0.55), rgba(92,10,10,0.15) 40%, rgba(92,10,10,0.88))'
            }}
          />
          <div
            style={{
        ...
        {guestName && (
          <section
            style={{
              ...
              padding: '28px 24px',
              textAlign: 'center',
              borderBottom: `1px solid rgba(212,168,48,0.25)`
            }}
          >
            <p
              style={{
            ...
            <p style={{ fontSize: 'clamp(1.3rem,5vw,2rem)', fontFamily: "'Noto Serif SC', serif", color: red }}>
              {guestName}
            </p>
          </section>
        )}
