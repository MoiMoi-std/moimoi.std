...
export default function MinimalistGeneralView({ wedding }: TemplateProps) {
    ...
    return (
      <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: bg }}>
        <div style={{ textAlign: 'center', padding: 40 }}>
          <p style={{ fontSize: 12, letterSpacing: '0.3em', color: inkLight, textTransform: 'uppercase', marginBottom: 16 }}>NOT FOUND</p>
          <h1 style={{ color: ink, fontFamily: "'Cormorant Garamond', serif", fontSize: '2.5rem' }}>Không tìm thấy thiệp cưới</h1>
        </div>
      </div>
    )
  }
  ...
  return (
    <>
      <Head>
        <title>{mergedContent.groom_name} &amp; {mergedContent.bride_name}</title>
      ...
      <div style={{
        ...
        <section style={{ position: 'relative', minHeight: '100vh', display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
          ...
          {/* Top bar */}
          <div style={{ padding: '28px 40px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', position: 'relative', zIndex: 10 }}>
            <p className='m-in' style={{ fontSize: 9, letterSpacing: '0.5em', color: 'rgba(255,255,255,0.6)', textTransform: 'uppercase' }}>WEDDING INVITATION</p>
            <p className='m-in' style={{ fontSize: 9, letterSpacing: '0.4em', color: 'rgba(255,255,255,0.45)', textTransform: 'uppercase' }}>MoiMoi Studio</p>
          </div>
          ...
          <div style={{
            position: 'absolute', inset: 0,
            background: 'linear-gradient(to bottom, rgba(0,0,0,0.08) 0%, rgba(0,0,0,0.18) 40%, rgba(0,0,0,0.72) 85%, rgba(0,0,0,0.88) 100%)'
          }} />

          {/* Names — positioned at bottom of hero */}
          <div style={{
            marginTop: 'auto', padding: '60px 44px 56px',
            position: 'relative', zIndex: 1,
            textAlign: 'center', display: 'flex', flexDirection: 'column', alignItems: 'center'
          }}>
            <div className='m-accent-line m-up' style={{ width: 40, marginBottom: 28 }} />

            <h1 className='m-up m-d1' style={{
            ...
            <div className='m-up m-d2' style={{ display: 'flex', alignItems: 'center', gap: 20, margin: '20px 0' }}>
              ...
              <p style={{ fontSize: 13, fontWeight: 300, letterSpacing: '0.18em', color: 'rgba(255,255,255,0.6)', textTransform: 'uppercase' }}>and</p>
              <div className='m-accent-line' style={{ width: 28 }} />
            </div>

            <h1 className='m-up m-d3' style={{
              fontSize: 'clamp(3.5rem, 11vw, 8rem)',
              fontWeight: 300, fontStyle: 'italic',
              color: '#ffffff', lineHeight: 0.92,
              letterSpacing: '-0.01em',
            ...
            {mergedContent.wedding_date && (
              <p className='m-up m-d4' style={{ fontSize: 14, fontWeight: 300, letterSpacing: '0.12em', color: 'rgba(255,255,255,0.65)' }}>
          ...
          <div className='m-scroll-arr' style={{ position: 'absolute', bottom: 28, right: 44, zIndex: 2 }}>
            <svg width='20' height='36' viewBox='0 0 20 36' fill='none'>
              ...
              <path d='M4 22l6 8 6-8' stroke='rgba(255,255,255,0.5)' strokeWidth='1.5' fill='none' strokeLinecap='round'/>
            </svg>
          </div>
        </section>
        ...
        <section style={{ padding: '100px 44px', borderBottom: `1px solid ${inkFaint}` }}>
          <div style={{ maxWidth: 700 }}>
            ...
            <p className='m-up' style={{
              fontSize: 'clamp(1.1rem, 3.5vw, 1.5rem)',
              fontWeight: 300, fontStyle: 'italic',
              color: inkMid, lineHeight: 1.9, letterSpacing: '0.01em'
            }}>
              Hai gia đình trân trọng kính mời quý vị tới dự lễ thành hôn của
            </p>
            <p className='m-up m-d1' style={{
        ...
        {timeRemaining && (
          <section style={{ padding: '100px 44px', borderBottom: `1px solid ${inkFaint}` }}>
            <div style={{ maxWidth: 820 }}>
              <p className='m-up' style={{ fontSize: 9, letterSpacing: '0.5em', color: accent, textTransform: 'uppercase', marginBottom: 52 }}>
                COUNTDOWN
              </p>
                ...
                {[
                  ...
                  >
                    <div style={{
                      ...
                      color: ink, lineHeight: 1, marginBottom: 16
                    }}>
        ...
        <section style={{ padding: '100px 44px', borderBottom: `1px solid ${inkFaint}` }}>
          <div style={{ maxWidth: 820 }}>
            <p className='m-up' style={{ fontSize: 9, letterSpacing: '0.5em', color: accent, textTransform: 'uppercase', marginBottom: 56 }}>
              EVENT DETAILS
            </p>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px,1fr))', gap: 52 }}>
              {[
                ...
                <div key={label} className='m-up'>
                  <p style={{ fontSize: 9, letterSpacing: '0.4em', color: accent, textTransform: 'uppercase', marginBottom: 16, fontWeight: 400 }}>
                    {label}
                  </p>
                  <div className='m-accent-line' style={{ width: 20, marginBottom: 16 }} />
                  <p style={{ fontSize: 20, fontWeight: 300, color: ink, lineHeight: 1.65 }}>
                    {value || '—'}
                  </p>
                </div>
              ))}
        ...
        {(mergedContent.cover_image || albumImages.length > 0) && (
          <section style={{ padding: '100px 40px', borderTop: `1px solid ${ink}0d`, background: '#fafafa' }}>
            <div style={{ maxWidth: 1060, margin: '0 auto' }}>
              <p className='m-up' style={{ fontSize: 10, letterSpacing: '0.5em', color: inkLight, textTransform: 'uppercase', marginBottom: 56 }}>
                OUR MOMENTS
              </p>
              ...
              {mergedContent.cover_image && (
                <div className='m-photo' style={{ marginBottom: 16, maxHeight: 580, overflow: 'hidden' }}>
                  ...
                  <img
                    ...
                    alt='Wedding Cover'
                    style={{ width: '100%', objectFit: 'cover', maxHeight: 580, display: 'block', filter: 'grayscale(10%)' }}
                  />
                </div>
              )}
                  ...
                  {albumImages.map((img: string, i: number) => (
                    <div key={i} className='m-photo' style={{ height: 260 }}>
                      ...
                      <img
                        src={img}
                        alt={`Ảnh cưới ${i + 1}`}
                        style={{ width: '100%', height: '100%', objectFit: 'cover', display: 'block', filter: 'grayscale(8%)' }}
                      />
                    </div>
                  ))}
                </div>
        ...
        {mergedContent.account_number && (
          <section style={{ padding: '100px 44px', borderBottom: `1px solid ${inkFaint}` }}>
            <div style={{ maxWidth: 580 }}>
              <p className='m-up' style={{ fontSize: 9, letterSpacing: '0.5em', color: accent, textTransform: 'uppercase', marginBottom: 40 }}>
                GIFT
              </p>
              <p className='m-up m-d1' style={{ fontSize: 'clamp(1.1rem, 3vw, 1.5rem)', fontWeight: 300, color: inkMid, lineHeight: 1.9, marginBottom: 48, fontStyle: 'italic' }}>
              ...
              <div className='m-up m-d2' style={{ paddingTop: 36, borderTop: `1px solid ${inkFaint}` }}>
                {mergedContent.bank_name && (
                  <p style={{ fontSize: 11, fontWeight: 400, color: inkLight, letterSpacing: '0.18em', marginBottom: 12, textTransform: 'uppercase' }}>
                    {mergedContent.bank_name}
                  </p>
                )}
                <p style={{ fontSize: 'clamp(2rem, 6vw, 3.2rem)', fontWeight: 200, color: ink, letterSpacing: '0.04em', marginBottom: 12 }}>
                  {mergedContent.account_number}
                </p>
                {mergedContent.account_name && (
                  <p style={{ fontSize: 15, fontWeight: 300, color: inkMid, fontStyle: 'italic' }}>{mergedContent.account_name}</p>
                )}
              </div>
            </div>
          </section>
        ...
        {/* ══ Footer ══ */}
        <footer style={{ padding: '56px 44px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: 16 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-end', gap: 8 }}>
            ...
            <p style={{ fontSize: 9, color: inkLight, letterSpacing: '0.22em', textTransform: 'uppercase' }}>MoiMoi Studio</p>
          </div>
        </footer>
      </div>
    </>
